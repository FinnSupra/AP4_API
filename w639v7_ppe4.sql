...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 05 mai 2025 à 08:45
...
INSERT INTO `infirmiere` (`id`, `fichier_photo`, `infChef`) VALUES
(2, NULL, 1),
(3, NULL, 0),
(4, NULL, 0),
(12, NULL, 0),
...
INSERT INTO `lieu` (`idLieu`, `libelle`, `pays`) VALUES
(1, 'Randonnée en Mercantour', 'France'),
(2, 'Belle Ile en Mer', 'France'),
(3, 'Le golf du Morbihan', 'France'),
(4, 'Les chateaux de la Loire', 'France'),
(5, 'Découverte de Londres', 'Grande Bretagne'),
(6, 'Les Alpes', 'France'),
(7, 'New York', 'Etats Unis'),
(8, 'Ouest américain', 'Etats Unis'),
(9, 'Nord', 'Etats Unis');
...
--
-- Structure de la table `partir`
--

DROP TABLE IF EXISTS `partir`;
CREATE TABLE IF NOT EXISTS `partir` (
  `idSejour` char(8) NOT NULL,
  `idVille` int NOT NULL,
  `supplement` int DEFAULT NULL,
  PRIMARY KEY (`idSejour`,`idVille`),
  KEY `FK_PARTIR_VILLE` (`idVille`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Déchargement des données de la table `partir`
--

INSERT INTO `partir` (`idSejour`, `idVille`, `supplement`) VALUES
('E1101245', 3, 250),
('E1101245', 4, 150),
('E1101245', 6, 50),
('E1101246', 3, 250),
...
CREATE TABLE IF NOT EXISTS `sejour` (
  `idSejour` char(8) NOT NULL,
  `resumeSejour` char(128) DEFAULT NULL,
...
INSERT INTO `sejour` (`idSejour`, `resumeSejour`, `datedebut`, `dateFin`, `prix`, `nature`, `idLieu`) VALUES
('E1080071', 'La Plagne', '2024-02-12 00:00:00', '2024-02-22 00:00:00', 250, 'T', 6),
('E1080072', 'Chamonix et le Mont-Blanc', '2023-05-11 00:00:00', '2023-05-18 00:00:00', 320, 'T', 6),
('E1090071', 'La Plagne', '2025-04-09 00:00:00', '2025-04-16 00:00:00', 250, 'L', 6),
('E1090072', 'Chamonix et le Mont-Blanc', '2025-03-10 00:00:00', '2025-03-17 00:00:00', 350, 'T', 6),
('E1090073', 'Aiguille du Mont-Blanc en 5 jours par la voie nord', '2025-06-15 00:00:00', '2025-06-22 00:00:00', 650, 'T', 6),
('E1101245', 'Le tour pédestre de la plus belle ile de France', '2025-07-25 00:00:00', '2025-08-02 00:00:00', 420, 'T', 2),
('E1101246', 'Découverte de la Palais et sa citadelle Vauban', '2025-04-09 00:00:00', '2025-04-16 00:00:00', 210, 'T', 2),
('E2101030', 'Trés belle découverte des montagnes des Alpes de Haute Provence', '2024-04-09 00:00:00', '2024-04-16 00:00:00', 380, 'T', 1),
('E2102030', 'Trés belle découverte des montagnes des Alpes de Haute Provence', '2025-04-10 00:00:00', '2025-04-17 00:00:00', 400, 'T', 1),
('E2102045', 'Les grands lacs de l Ontario', '2024-04-09 00:00:00', '2024-04-16 00:00:00', 1800, 'T', 9),
('GB110124', 'Séjour linguistique à Londres', '2025-07-25 00:00:00', '2025-08-02 00:00:00', 800, 'L', 5),
('U1101240', 'De Los Angeles à Las Vegas', '2025-04-10 00:00:00', '2025-04-17 00:00:00', 2000, 'T', 8),
('U1101241', 'Le grand canyon du Colorado', '2025-04-09 00:00:00', '2025-04-16 00:00:00', 2500, 'T', 8),
('U1101242', 'Les grands lacs du Nord', '2025-03-10 00:00:00', '2025-03-17 00:00:00', 2500, 'T', 9),
('U1101243', 'New York en liberté', '2025-06-15 00:00:00', '2025-06-22 00:00:00', 2500, 'T', 7),
('U1101244', 'Séjour linguistique à New York', '2025-07-25 00:00:00', '2025-08-02 00:00:00', 2500, 'L', 7);
...
INSERT INTO `villedepart` (`idVille`, `nom`) VALUES
(1, 'Nice'),
(2, 'Marseille'),
(3, 'Paris'),
(4, 'Nantes'),
...
(1, 5, 12, '2024-05-18 16:00:00', '0000-00-00 00:00:00', 30, NULL, NULL),
(2, 6, 3, '2024-06-03 09:00:00', '0000-00-00 00:00:00', 30, '', NULL),
(3, 5, 2, '2024-05-31 10:30:00', '0000-00-00 00:00:00', 30, '', NULL),
(4, 5, 2, '2024-05-18 16:30:00', '0000-00-00 00:00:00', 45, '', NULL),
(6, 9, 3, '2024-06-02 09:15:00', '0000-00-00 00:00:00', 40, '', NULL),
(7, 11, 2, '2024-06-01 15:20:00', '0000-00-00 00:00:00', 35, '', NULL),
(8, 14, 3, '2024-06-02 16:40:00', '0000-00-00 00:00:00', 33, '', NULL),
(9, 9, 4, '2024-05-31 14:00:00', '0000-00-00 00:00:00', 50, NULL, NULL);
...
--
-- Contraintes pour la table `partir`
--
ALTER TABLE `partir`
  ADD CONSTRAINT `FK_PARTIR_SEJOUR` FOREIGN KEY (`idSejour`) REFERENCES `sejour` (`idSejour`),
  ADD CONSTRAINT `FK_PARTIR_VILLE` FOREIGN KEY (`idVille`) REFERENCES `villedepart` (`idVille`);
...
--
ALTER TABLE `sejour`
  ADD CONSTRAINT `FK_SEJOUR_LIEUB` FOREIGN KEY (`idLieu`) REFERENCES `lieu` (`idLieu`);
